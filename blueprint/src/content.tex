...
\begin{theorem}
  ...
  \uses{lem: zorn_base, lem: exists_uw_ge_normal, lem: msr_th_lemma, lem: cut_down_of_wstar, lem: spec_masa_wstar_stonean, lem: fin_lin_approx_of_stonean, lem: bdd_sigma_cts_iff_bdd_s_cts}
...
\begin{proof}
  ...
  there is a nonzero subprojection $p\le 1-p_0$ in $M$ such that $\varphi(q)\lt \psi(q)$ for every nonzero $q\le p$ in $M$. Let $x\in pMp$ be on the unit sphere. 
  ...
  $*$--subalgebra $A$ of $pMp$. Now $A$ is a $W^{*}$--subalgebra of $pMp$ and hence is a maximal commutative $C^{*}$--subalgebra of $pMp$. Via the Gelfand Transform, 
