...
\begin{proof}
  The claim is obvious for the zero functional. Let $\varphi$ be a nonzero positive normal linear functional. By Lemma \ref{zorn_base} there
  is a maximal $p_0\in \mathcal{P}(M)$ such that $M\ni x \mapsto \varphi(xp_0)$ is $\sigma(M,M_{*})$--continuous. By Lemma \ref{lem: exists_uw_ge_normal}
  there is a $\sigma(M,M_{*})$--continuous positive functional $\psi$ on $M$ such that $\varphi(1-p_0)<\psi(1-p_0)$.
\end{proof}
